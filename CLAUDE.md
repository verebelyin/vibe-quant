...
- **Compiler version hash:** stored in discovery notes for staleness detection. Current valid hash: `7eb70d8c4fb5` (was `8ae876464003`; changes when the indicator registry changes — computed by `compiler_version_hash()`)
