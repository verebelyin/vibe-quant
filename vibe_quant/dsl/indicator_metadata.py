...
_register(
    IndicatorMeta(
        ...
        default_period=20,
        popular=True,
        params=(IndicatorParam("period", "Period", 20, 2, 500, 1, "Number of bars to average"),),
    )
)
...
_register(
    IndicatorMeta(
        ...
        default_period=14,
        popular=True,
        params=(IndicatorParam("period", "Period", 14, 2, 100, 1, "Lookback period"),),
    )
)
...
_register(
    IndicatorMeta(
        ...
        default_period=14,
        params=(IndicatorParam("period", "Period", 14, 2, 100, 1, "%K lookback period"),),
    )
)
...
_register(
    IndicatorMeta(
        ...
        default_period=20,
        params=(IndicatorParam("period", "Period", 20, 5, 200, 1, "Lookback period"),),
    )
)
...
_register(
    IndicatorMeta(
        ...
        default_period=12,
        params=(IndicatorParam("period", "Period", 12, 1, 200, 1, "Lookback period"),),
    )
)
...
_register(
    IndicatorMeta(
        ...
        default_period=20,
        params=(IndicatorParam("period", "Period", 20, 5, 200, 1, "Lookback period for high/low"),),
    )
)
...
_register(
    IndicatorMeta(
        ...
        category="Volume",
        description="Average price weighted by volume. Resets daily. Institutional benchmark.",
